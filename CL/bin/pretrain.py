...
if __name__ == "__main__":
    # file = open("/mnt/lpai-dione/ssai/cvg/team/qiuyin/zyz/classification/0_CSCL_MyACROBAT_AddLoss/train.txt","w")
    # sys.stdout=file
    # set seed
    ...
    # set up losses
    loss_fn_interMod, loss_fn_interMod_local, loss_fn_intraMod, criterionASP = setup_losses(args)
    ...
    for epoch in range(args.max_epochs):
        ...
        # train
        start = time.time()
        ep_loss = train_loop(args, loss_fn_interMod, loss_fn_interMod_local, loss_fn_intraMod, criterionASP, ssl_model, epoch, dataloader, optimizer, scheduler_warmup, scheduler)
        ...
        if epoch > 20 and epoch % 10 == 0:
            ...
            torch.save(ssl_model.state_dict(), os.path.join(args.RESULS_SAVE_PATH, 'epoch'+str(epoch)+"_model.pt"))
            print()
