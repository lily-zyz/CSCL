...
# local_dir = ''
# snap_download(repo_id="hf_hub:MahmoodLab/CSCL", local_dir=local_dir)
...
def create_model_from_pretrained(local_dir: str):
    ...
    # snapshot_download(repo_id="MahmoodLab/CSCL", local_dir=local_dir)

    # load config and weights 
    model_cfg = json.load(open(os.path.join(local_dir, "config.json")))
