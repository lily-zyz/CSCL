...
from core.models.Model import CSCL
...
def build_downstream_datasets(args):
    ...
    bcnb_dataset = SlideDataset(
        ...
        features_path="/mnt/lpai-dione/ssai/cvg/team/qiuyin/zyz/classification/results/BCNB2/processing_slides_933_mag_10x_patchsize_256/patch_embeddings",
        modalities=["HE"],
        train=False
    )
