...
To run with CSCL slide embeddings:
python run_linear_probing.py --slide_embedding_pkl ../results/BCNB/CSCL_slide_embeddings.pkl  --label_path ../dataset_csv/BCNB/BCNB.csv 
...
BRCA_BREAST_TASKS = ['oncotree_code']
